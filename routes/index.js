...
router.get('/', async ctx => {
  const { pageNum = 1, perPage = 15, sort = 'created_at', ascOrDesc = 'desc', specName, specValue, showProducts, showSubscriptions } = ctx.query;
  ...
  await ctx.render('index', { items, pages, ...ctx.query });
});
